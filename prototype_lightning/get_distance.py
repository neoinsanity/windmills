...
def get_distance_with_geopy(obj, fields, logger_sender_socket) -> float:
    import geopy.distance
    for p in fields:
        coords_1 = (obj["lon"], obj["lat"])
        coords_2 = (p["lon"], p["lat"])
...
def get_distance_with_geopandas(obj, fields, logger_sender_socket) -> float:
    """
